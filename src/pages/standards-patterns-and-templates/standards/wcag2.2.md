...
This page defines the accessibility baseline for LAP modernisation work and links to authoritative WCAG guidance.
...
- **Operable** – Interfaces must work with different inputs, including keyboard-only use.
...
- Consistent Help
- Reduced repetitive input (Redundant Entry)
